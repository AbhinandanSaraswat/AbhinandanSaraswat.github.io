...
document.getElementById("git1Button").addEventListener("click",function(){
    window.open("https://github.com/Sandeeprawat313/Lifestyle-Clone.git", "_blank");
})
document.getElementById("deploy1Button").addEventListener("click",function(){
    window.open("https://shimmering-vacherin-7a95eb.netlify.app/", "_blank");
})

document.getElementById("git2Button").addEventListener("click",function(){
    window.open("https://github.com/aakashindoriya/acrid-land-8684", "_blank");
})
document.getElementById("deploy2Button").addEventListener("click",function(){
    window.open("https://astounding-scone-73c2d5.netlify.app/", "_blank");
})
...
document.getElementById("linkedin").addEventListener("click",function(){
    window.open("https://www.linkedin.com/in/abhinandan-saraswat-23a31a156/");
})
...
function resumeDownload(){
        ...
        window.open("fw19_0798-Abhinandan-Saraswat-Resume.pdf","_blank");
      }